...
def get_mic_card():
    ...
    if card is not None:
        ...
        return card
    print("[MIC] No mic found â€” using card 2")
    return 2
...
def get_speaker_card():
    ...
    if card is not None:
        ...
        return card
    print("[SPEAKER] No USB speaker â€” using card 3")
    return 3
...
def record_audio(duration=3):
    ...
    try:
        ...
        # Convert â†’ 16kHz mono 16-bit for Whisper
        conv_cmd = [
            'sox', RAW_PATH,
            '-r', '16000',
            '-b', '16',
        ...
        print(f"[MIC] Saved â†’ {RECORD_PATH}")
        return RECORD_PATH
